...
## Summary
- 864 nodes · 2123 edges · 64 communities (35 shown, 29 thin omitted)
- Extraction: 81% EXTRACTED · 19% INFERRED · 0% AMBIGUOUS · INFERRED: 402 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2635903c`
...
Cohesion: 0.07
Nodes (33): Planner, PlanRequest, Turns a transcript plus a tool catalogue into the next step., What the planner is given. Deliberately model-agnostic., Role, CommandFastPath, Commands answered deterministically; everything else goes to a model. Ownership…, LlmPlanner (+25 more)
...
Cohesion: 0.09
Nodes (29): AuditEvent, AuditRecord, AuditStore, ChainBreak, HashChainAuditSink, InMemoryAuditStore, Protocol, Tamper-evident action log. Each record carries the hash of the one before it,… (+21 more)
...
Cohesion: 0.09
Nodes (20): AsyncClient, BaseException, BaseSettings, Completion, GenerationError, _has_result(), Any, Client for the platform's text generation endpoint. ``type=text`` is… (+12 more)
...
Cohesion: 0.19
Nodes (14): Turns a Telegram message into an agent turn, or refuses it., TelegramGateway, bindings(), make_message(), BindingTable, Message, parametrize, The Telegram surface: who gets in, and whose tenant they act as. (+6 more)
...
Cohesion: 0.33
Nodes (5): AuditSink, Guard, Deterministic-first gate in front of every call. Implementations run cheap…, Where action records go. The hash chain lives in the implementation., Protocol

### Community 33 - "Community 33"
Cohesion: 0.40
Nodes (5): fixture, ToolContext, Always calls the spy tool, then reports what it saw., spy_agent(), SpyTenantPlanner
...
- **Why does `ToolRegistry` connect `Community 17` to `Community 5`, `Community 6`, `Community 22`, `Community 25`, `Community 27`, `Community 29`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `PlanRequest` connect `Community 2` to `Community 33`, `Community 5`, `Community 8`, `Community 10`, `Community 11`, `Community 13`, `Community 16`, `Community 28`?**
