...
## Summary
- 890 nodes · 2054 edges · 69 communities (32 shown, 37 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 325 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `66cd6612`
...
Cohesion: 0.09
Nodes (16): ConfigurationError, The adapter is pointed somewhere it was not meant to reach., mock, error_body(), Any, If this ever stops being null the tool description is a lie., What a challenge page or a proxy error actually looks like., The contract really does declare 201 here, not 200. (+8 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (25): ItmanoCrmClient, One client per process. Holds the connection pool; owns no state., ItmanoCrmSettings, Configuration for the ITMANO CRM adapter. Everything arrives via env vars., Connection details plus the assertion that guards against pointing here at the…, contract_version(), load_contract(), Operation (+17 more)
...
Cohesion: 0.16
Nodes (10): fixture, crm(), crm_registry(), ItmanoCrmSettings, Offline tests for the CRM adapter. Every response here comes from…, The planner sees descriptions and nothing else., settings(), TestContract (+2 more)
...
- **Why does `ToolRegistry` connect `Community 0` to `Community 20`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `CommandPlanner` connect `Community 18` to `Community 14`, `Community 17`, `Community 22`, `Community 24`, `Community 26`, `Community 28`, `Community 30`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `ItmanoCrmClient` connect `Community 7` to `Community 3`, `Community 6`, `Community 13`, `Community 16`, `Community 23`, `Community 29`?**
