...
## Summary
- 876 nodes · 2093 edges · 66 communities (33 shown, 33 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 370 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fd136238`
...
Cohesion: 0.05
Nodes (80): Agent, AuditEvent, AuditPhase, ExecutedCall, GuardDecision, Plan, BaseModel, Orchestration loop: intent, plan, guard, execute, report. The loop owns the… (+72 more)
...
Cohesion: 0.06
Nodes (35): BaseException, Completion, GenerationError, _has_result(), Any, Client for the platform's text generation endpoint. ``type=text`` is…, Price and validate a generation without spending anything. Free, and the honest…, Begin a paid generation. Always strict: malformed params are rejected before… (+27 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (42): Any, CreateEmailDraftParams, CreateLeadParams, CreateNoteParams, GetDealParams, GetLeadParams, Intent, Language (+34 more)
...
Cohesion: 0.13
Nodes (18): Planner, PlanRequest, Turns a transcript plus a tool catalogue into the next step., What the planner is given. Deliberately model-agnostic., Role, CommandFastPath, A deterministic planner for explicit commands. CONDUIT's orchestration loop…, Commands answered deterministically; everything else goes to a model. Ownership… (+10 more)

### Community 8 - "Community 8"
Cohesion: 0.12
Nodes (13): AgentReply, AuditSink, Guard, NullAuditSink, ToolCall, ToolContext, ToolSpec, Deterministic-first gate in front of every call. Implementations run cheap… (+5 more)
...
Cohesion: 0.12
Nodes (15): BaseSettings, ItmanoCrmSettings, Configuration for the ITMANO CRM adapter. Everything arrives via env vars., Connection details plus the assertion that guards against pointing here at the…, contract_version(), load_contract(), Operation, operations() (+7 more)
...
Cohesion: 0.22
Nodes (6): CommandPlanner, Any, Turn the tool result at the end of the transcript into a reply., Say what happened without repeating an upstream message verbatim., Maps one command to one tool call, then renders the result., _truncate()
...
Cohesion: 0.32
Nodes (7): LlmPlanner, completion(), mock, An unbounded repair loop is a hole in the cost ceiling., A 500 is not a parse problem; repeating the same prompt will not fix it., request_for(), TestRetry

### Community 20 - "Community 20"
Cohesion: 0.16
Nodes (9): Notified of each call the guard has allowed, just before it runs. The point is…, StepReporter, Message, Send one line per allowed call, before it runs., Keep the 'typing' state alive while the turn runs., What the last turn cost, and on which model. Model choice is a decision made on…, Record enough to write a binding, and nothing the sender said. The chat id is…, Resolution (+1 more)

### Community 21 - "Community 21"
Cohesion: 0.21
Nodes (10): Which conversation may act for which tenant. This module is the authorization…, build_dispatcher(), BindingTable, Telegram surface: resolve the conversation, then hand off to the agent. Replies…, Long-poll for updates. Deployment swaps this for a webhook., run(), Configuration for the Telegram interface., TelegramSettings (+2 more)
...
Cohesion: 0.23
Nodes (7): describe_step(), ToolCall, ToolSpec, One line saying what the agent decided, before it acts on it. Shows the…, The 80-second wait is only bearable if it is announced., An expected wait is patience; an unexplained one reads as a crash., TestStepDescriptions
...
Cohesion: 0.32
Nodes (7): bindings(), fixture, ToolContext, The Telegram surface: who gets in, and whose tenant they act as., Always calls the spy tool, then reports what it saw., spy_agent(), SpyTenantPlanner
...
Cohesion: 0.67
Nodes (4): planner(), fixture, settings(), VibemarketologSettings
...
- **Why does `ToolRegistry` connect `Community 0` to `Community 4`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `ItmanoCrmClient` connect `Community 13` to `Community 3`, `Community 11`, `Community 12`, `Community 14`, `Community 18`, `Community 26`, `Community 31`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `PlanRequest` connect `Community 7` to `Community 0`, `Community 8`, `Community 15`, `Community 16`, `Community 19`, `Community 22`, `Community 23`, `Community 25`, `Community 28`, `Community 29`?**
